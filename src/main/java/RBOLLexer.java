...
public class RBOLLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "SCAN", "SCAND", "PRINT", "LONG", "FLOAT", "DOUBLE", "ADD", "SUBSTRACT", 
			"MUL", "DIVIDE", "ID", "INT", "STRING", "WS"
		};
	}
	...
	public RBOLLexer(CharStream input) {
		super(input);
